...
import { increaseSongTime } from '../../../containers/SpotifyPage/actions';
...
const mapStateToProps = (state) => {
  ...
  return {
    songName: state.spotify.songDetails ? state.spotify.songDetails.name : '',
    artistName: state.spotify.songDetails ? state.spotify.songDetails.artists[0].name : '',
    songPlaying: state.spotify.songPlaying,
    timeElapsed: state.spotify.timeElapsed,
    songPaused: state.spotify.songPaused,
    songDetails: state.spotify.songDetails,
    songs: state.spotify.songs
  };
