...
import { fetchCategories, fetchNewReleases, fetchFeatured, updateHeaderTitle, updateViewType } from '../../../containers/SpotifyPage/actions';
...
const mapStateToProps = (state) => {
  ...
  return {
    ...
    headerTitle: state.spotify.title,
