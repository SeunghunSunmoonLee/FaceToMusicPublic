...
import { fetchSongs, addSongToLibrary } from '../../../containers/SpotifyPage/actions';
...
const mapStateToProps = (state) => {
  ...
  return {
    ...
    songs: state.spotify.songs ? state.spotify.songs : '',
    fetchSongsError: state.spotify.fetchSongsError,
    fetchSongsPending: state.spotify.fetchSongsPending,
    fetchPlaylistSongsPending: state.spotify.fetchPlaylistSongsPending,
    songPlaying: state.spotify.songPlaying,
    songPaused: state.spotify.songPaused,
    songId: state.spotify.songId,
    songAddedId: state.spotify.songId || '',
