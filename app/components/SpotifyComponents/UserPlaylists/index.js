...
import { fetchPlaylistsMenu, fetchPlaylistSongs, updateHeaderTitle } from '../../../containers/SpotifyPage/actions';
...
const mapStateToProps = (state) => {
	...
	return {
		...
		playlistMenu: state.spotify.playlistMenu ? state.spotify.playlistMenu : '',
